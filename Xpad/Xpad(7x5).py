...
class Table(QWidget):
	def __init__(self):
		...
		self.labelAlfa.setText(a)
		self.labelAlfa.setFont(QFont("Timers",16,QFont.Bold))
		self.labelAlfa.setAlignment(Qt.AlignCenter)
	...
	def initGUI(self):
		...
		h_box11 = QHBoxLayout()
		self.txt11.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt12.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt13.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt14.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt15.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt16.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt17.setStyleSheet("background-color:rgb(239, 239, 239)")
		...
		self.txt21.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt22.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt23.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt24.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt25.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt26.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt27.setStyleSheet("background-color:rgb(239, 239, 239)")
		h_box21 = QHBoxLayout()
		...
		self.txt31.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt32.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt33.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt34.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt35.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt36.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt37.setStyleSheet("background-color:rgb(239, 239, 239)")
		h_box31 = QHBoxLayout()
		...
		self.txt41.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt42.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt43.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt44.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt45.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt46.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt47.setStyleSheet("background-color:rgb(239, 239, 239)")
		h_box41 = QHBoxLayout()
		...
		self.txt51.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt52.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt53.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt54.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt55.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt56.setStyleSheet("background-color:rgb(239, 239, 239)")
		self.txt57.setStyleSheet("background-color:rgb(239, 239, 239)")
		h_box51 = QHBoxLayout()
